...
# Kept as an alias so `from .cli import coerce_setting` still resolves; the
# implementation lives in config.py because the GUI needs it too.
coerce_setting = coerce_value
